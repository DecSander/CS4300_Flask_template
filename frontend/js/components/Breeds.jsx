...
function mapStateToProps({ search, currentBreeds, preferences, breedsLoading, checkPreferences, page }) {
  return { search, currentBreeds, preferences, breedsLoading, checkPreferences, page };
}
